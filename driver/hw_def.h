...
#define XPU_REG_SHORT_PREAMBLE_DETECTED_VAL_LOW_ADDR    (12*4)
#define XPU_REG_SHORT_PREAMBLE_DETECTED_VAL_HIGH_ADDR   (13*4)
#define XPU_REG_LONG_PREAMBLE_DETECTED_VAL_LOW_ADDR     (14*4)
#define XPU_REG_LONG_PREAMBLE_DETECTED_VAL_HIGH_ADDR    (15*4) 
...
#define XPU_LEGACY_SIG_STB_VAL_LOW_ADDR   (24*4)
#define XPU_LEGACY_SIG_STB_VAL_HIGH_ADDR  (25*4)
...
#define XPU_REG_TSF_CYCTIME_VAL_LOW_ADDR  (32*4)
#define XPU_REG_TSF_CYCTIME_VAL_HIGH_ADDR (33*4)
...
#define XPU_REG_WRITE_BEACON_VAL_LOW_ADDR    (44*4)
#define XPU_REG_WRITE_BEACON_VAL_HIGH_ADDR   (45*4)
#define XPU_REG_READ_BEACON_VAL_LOW_ADDR     (46*4)
#define XPU_REG_READ_BEACON_VAL_HIGH_ADDR    (47*4)
#define XPU_REG_RECEIVE_BEACON_VAL_LOW_ADDR  (48*4)
#define XPU_REG_RECEIVE_BEACON_VAL_HIGH_ADDR (49*4)

#define XPU_REG_TRX_STATUS_ADDR           (50*4)
#define XPU_REG_TX_RESULT_ADDR            (51*4)

#define XPU_REG_WRITE_RESPONSE_VAL_LOW_ADDR    (52*4)
#define XPU_REG_WRITE_RESPONSE_VAL_HIGH_ADDR   (53*4)
#define XPU_REG_READ_RESPONSE_VAL_LOW_ADDR     (54*4)
#define XPU_REG_READ_RESPONSE_VAL_HIGH_ADDR    (55*4)
#define XPU_REG_RECEIVE_RESPONSE_VAL_LOW_ADDR  (56*4)
#define XPU_REG_RECEIVE_RESPONSE_VAL_HIGH_ADDR (57*4)
...
struct xpu_driver_api {
	...
	u32  (*XPU_REG_WRITE_BEACON_VAL_LOW_read)(void);
	u32  (*XPU_REG_WRITE_BEACON_VAL_HIGH_read)(void);
	u32  (*XPU_REG_READ_BEACON_VAL_LOW_read)(void);
	u32  (*XPU_REG_READ_BEACON_VAL_HIGH_read)(void);
	u32  (*XPU_REG_RECEIVE_BEACON_VAL_LOW_read)(void);
	u32  (*XPU_REG_RECEIVE_BEACON_VAL_HIGH_read)(void);

	u32  (*XPU_LEGACY_SIG_STB_VAL_LOW_read)(void);
	u32  (*XPU_LEGACY_SIG_STB_VAL_HIGH_read)(void);

	u32  (*XPU_REG_TRX_STATUS_read)(void);
	u32  (*XPU_REG_TX_RESULT_read)(void);

	u32  (*XPU_REG_WRITE_RESPONSE_VAL_LOW_read)(void);
	u32  (*XPU_REG_WRITE_RESPONSE_VAL_HIGH_read)(void);
	u32  (*XPU_REG_READ_RESPONSE_VAL_LOW_read)(void);
	u32  (*XPU_REG_READ_RESPONSE_VAL_HIGH_read)(void);
	u32  (*XPU_REG_RECEIVE_RESPONSE_VAL_LOW_read)(void);
	u32  (*XPU_REG_RECEIVE_RESPONSE_VAL_HIGH_read)(void);

	u32  (*XPU_REG_TSF_RUNTIME_VAL_LOW_read)(void);
	u32  (*XPU_REG_TSF_RUNTIME_VAL_HIGH_read)(void);

	u32  (*XPU_REG_TSF_CYCTIME_VAL_LOW_read)(void);
	u32  (*XPU_REG_TSF_CYCTIME_VAL_HIGH_read)(void);

	u32  (*XPU_REG_SHORT_PREAMBLE_DETECTED_VAL_LOW_read)(void);
	u32  (*XPU_REG_SHORT_PREAMBLE_DETECTED_VAL_HIGH_read)(void);

	u32  (*XPU_REG_LONG_PREAMBLE_DETECTED_VAL_LOW_read)(void);
	u32  (*XPU_REG_LONG_PREAMBLE_DETECTED_VAL_HIGH_read)(void);
