...
static inline u32 TX_INTF_REG_ADC_FIFO_DEPTH_read(void){
	return reg_read(TX_INTF_REG_ADC_FIFO_DEPTH_ADDR);
}
...
static inline void TX_INTF_REG_ADC_FIFO_DEPTH_write(u32 value){
	reg_write(TX_INTF_REG_ADC_FIFO_DEPTH_ADDR, value);
}
...
static int dev_probe(struct platform_device *pdev)
{
	...
	tx_intf_api->TX_INTF_REG_ADC_FIFO_DEPTH_read=TX_INTF_REG_ADC_FIFO_DEPTH_read;
